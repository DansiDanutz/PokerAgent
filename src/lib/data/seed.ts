...
export const SEED_USERS: User[] = [
  user("u_admin", "admin", "Platform Admin", "admin", null, "ADMIN-ROOT", 0, {
    kycStatus: "verified",
    stats: { handsPlayed: 0, netProfit: 0, rakeGenerated: 0, winRateBb100: 0, sessions: 0 },
  }),
  ...
  user("u_arjun", "arjunmehta", "Arjun Mehta", "agent", null, "PAGENT-ARJUN12", 825_000, {
    ...
    stats: { handsPlayed: 48230, netProfit: 1_240_000, rakeGenerated: 96_000, winRateBb100: 6.4, sessions: 612 },
  }),
  ...
  user("u_alex", "alexplayer", "Alex Player", "player", "u_arjun", "PA-ALEX-77", 125_500, {
    ...
    stats: { handsPlayed: 18420, netProfit: 248_000, rakeGenerated: 21_500, winRateBb100: 4.1, sessions: 233 },
  }),
  user("u_sara", "saralin", "Sara Lin", "player", "u_arjun", "PA-SARA-21", 64_200, {
    country: "Singapore", clubggId: "8842027",
    kycStatus: "pending",
    stats: { handsPlayed: 9120, netProfit: -12_400, rakeGenerated: 8_800, winRateBb100: -1.2, sessions: 140 },
  }),
  ...
  user("u_marco", "marcorossi", "Marco Rossi", "agent", "u_arjun", "PA-MARCO-09", 312_000, {
    ...
    stats: { handsPlayed: 22100, netProfit: 410_000, rakeGenerated: 39_000, winRateBb100: 5.0, sessions: 301 },
  }),
  user("u_diego", "diegop", "Diego Pérez", "player", "u_marco", "PA-DIEGO-03", 41_800, {
    country: "Spain", clubggId: "8842041",
    stats: { handsPlayed: 7600, netProfit: 53_000, rakeGenerated: 6_900, winRateBb100: 3.3, sessions: 96 },
  }),
  user("u_yuki", "yukitanaka", "Yuki Tanaka", "player", "u_marco", "PA-YUKI-88", 9_900, {
    country: "Japan", clubggId: "8842055",
    kycStatus: "unverified",
    status: "active",
    stats: { handsPlayed: 2100, netProfit: -3_200, rakeGenerated: 1_900, winRateBb100: -2.1, sessions: 31 },
  }),
  ...
  user("u_nadia", "nadiak", "Nadia Kovac", "agent", null, "PAGENT-NADIA7", 158_000, {
    ...
    stats: { handsPlayed: 15300, netProfit: 190_000, rakeGenerated: 17_400, winRateBb100: 3.8, sessions: 188 },
  }),
  user("u_tom", "tomh", "Tom Holloway", "player", "u_nadia", "PA-TOM-55", 22_300, {
    country: "UK", clubggId: "8842078",
    stats: { handsPlayed: 5400, netProfit: 12_000, rakeGenerated: 4_200, winRateBb100: 1.4, sessions: 70 },
  }),
];
